...
contract Coinflip is Ownable{
    ...
    /// @param Guesses fixed array of 10 elements which holds the user's guesses. The guesses are either 1 or 0 for heads or tails
    ...
    /// @param NewSeed string which represents the new seed
...
// -------------------- helper functions -------------------- //
    ...
    /// @dev No input as only the seed is used for generating the guesses
    /// @return results_array a fixed 10 element array of type uint8 with only 1 or 0 as its elements
